...
INSERT INTO BANNERDATA VALUES ('FISH','<image src="/jpetstore/images/banner_fish.gif">');
INSERT INTO BANNERDATA VALUES ('CATS','<image src="/jpetstore/images/banner_cats.gif">');
INSERT INTO BANNERDATA VALUES ('DOGS','<image src="/jpetstore/images/banner_dogs.gif">');
INSERT INTO BANNERDATA VALUES ('REPTILES','<image src="/jpetstore/images/banner_reptiles.gif">');
INSERT INTO BANNERDATA VALUES ('BIRDS','<image src="/jpetstore/images/banner_birds.gif">');

INSERT INTO CATEGORY VALUES ('FISH','Fish','<image src="/jpetstore/images/fish_icon.gif"><font size="5" color="blue"> Fish</font>');
INSERT INTO CATEGORY VALUES ('DOGS','Dogs','<image src="/jpetstore/images/dogs_icon.gif"><font size="5" color="blue"> Dogs</font>');
INSERT INTO CATEGORY VALUES ('REPTILES','Reptiles','<image src="/jpetstore/images/reptiles_icon.gif"><font size="5" color="blue"> Reptiles</font>');
INSERT INTO CATEGORY VALUES ('CATS','Cats','<image src="/jpetstore/images/cats_icon.gif"><font size="5" color="blue"> Cats</font>');
INSERT INTO CATEGORY VALUES ('BIRDS','Birds','<image src="/jpetstore/images/birds_icon.gif"><font size="5" color="blue"> Birds</font>');

INSERT INTO PRODUCT VALUES ('FI-SW-01','FISH','Angelfish','<image src="/jpetstore/images/fish1.gif">Salt Water fish from Australia');
INSERT INTO PRODUCT VALUES ('FI-SW-02','FISH','Tiger Shark','<image src="/jpetstore/images/fish4.gif">Salt Water fish from Australia');
INSERT INTO PRODUCT VALUES ('FI-FW-01','FISH', 'Koi','<image src="/jpetstore/images/fish3.gif">Fresh Water fish from Japan');
INSERT INTO PRODUCT VALUES ('FI-FW-02','FISH', 'Goldfish','<image src="/jpetstore/images/fish2.gif">Fresh Water fish from China');
INSERT INTO PRODUCT VALUES ('K9-BD-01','DOGS','Bulldog','<image src="/jpetstore/images/dog2.gif">Friendly dog from England');
INSERT INTO PRODUCT VALUES ('K9-PO-02','DOGS','Poodle','<image src="/jpetstore/images/dog6.gif">Cute dog from France');
INSERT INTO PRODUCT VALUES ('K9-DL-01','DOGS', 'Dalmation','<image src="/jpetstore/images/dog5.gif">Great dog for a Fire Station');
INSERT INTO PRODUCT VALUES ('K9-RT-01','DOGS', 'Golden Retriever','<image src="/jpetstore/images/dog1.gif">Great family dog');
INSERT INTO PRODUCT VALUES ('K9-RT-02','DOGS', 'Labrador Retriever','<image src="/jpetstore/images/dog5.gif">Great hunting dog');
INSERT INTO PRODUCT VALUES ('K9-CW-01','DOGS', 'Chihuahua','<image src="/jpetstore/images/dog4.gif">Great companion dog');
INSERT INTO PRODUCT VALUES ('RP-SN-01','REPTILES','Rattlesnake','<image src="/jpetstore/images/snake1.gif">Doubles as a watch dog');
INSERT INTO PRODUCT VALUES ('RP-LI-02','REPTILES','Iguana','<image src="/jpetstore/images/lizard1.gif">Friendly green friend');
INSERT INTO PRODUCT VALUES ('FL-DSH-01','CATS','Manx','<image src="/jpetstore/images/cat2.gif">Great for reducing mouse populations');
INSERT INTO PRODUCT VALUES ('FL-DLH-02','CATS','Persian','<image src="/jpetstore/images/cat1.gif">Friendly house cat, doubles as a princess');
INSERT INTO PRODUCT VALUES ('AV-CB-01','BIRDS','Amazon Parrot','<image src="/jpetstore/images/bird2.gif">Great companion for up to 75 years');
INSERT INTO PRODUCT VALUES ('AV-SB-02','BIRDS','Finch','<image src="/jpetstore/images/bird1.gif">Great stress reliever');
